...
Multithreading can have many benifits for a apllication, some of that are pointed out at "Quelle":
\begin{itemize}
...
% from http://www.zdv.uni-mainz.de/cms-extern/DUS/progtool/dce31unx/develop/appdev/Appde153.htm
    \item Using threads improves the performance of a programm, it raises the computiation speed of the application.
    \item Multiple threads are most used in mulitprocessor system but using threads can also improve application on single processor devices 
...
the player. The player communicates with other applications on the device over a pipe ...
